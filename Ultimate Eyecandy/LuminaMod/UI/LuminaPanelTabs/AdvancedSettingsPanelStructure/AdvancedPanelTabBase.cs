namespace Lumina
{
    ...
    /// <summary>
    /// Lumina advanced panel tab base.
    /// </summary>
    internal class AdvancedPanelTabBase
    {
        /// <summary>
        /// Layout margin.
        /// </summary>
        protected const float Margin = 8f;

        /// <summary>
        /// Text header layout height.
        /// </summary>
        protected const float HeaderHeight = 10f;

        /// <summary>
        /// Checkbox UI layout height.
        /// </summary>
        protected const float CheckHeight = 15f;

        /// <summary>
        /// Slider UI layout height.
        /// </summary>
        protected const float SliderHeight = 30f;
        ...
        private const float ValueLabelWidth = 25f;
        private const float SliderTextScale = 1f;
        private const float SliderTextHeight = 15f;
